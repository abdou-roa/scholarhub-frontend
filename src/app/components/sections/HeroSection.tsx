      ...
      <div className="container py-16 lg:py-16">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            ...
            🚀 Master React: Build Modern Web Applications with Ease! 🚀
            </h1>
            <p className="mt-3 text-xl text-muted-foreground">
            Become a proficient React developer and elevate your web development skills with our comprehensive course. Whether you are a beginner or looking to deepen your knowledge, our course is designed to guide you from basics to advanced concepts.
            </p>
            {/* Buttons */}
